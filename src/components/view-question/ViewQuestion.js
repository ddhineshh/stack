...
function ViewQuestion() {
    ...
    const handleAnswer = async (e) => {
        ...
        if (userContext.user.email) {
            if (answer.length >=10) {
                ...
                await axios.post('https://stack-overflow-clone-backend.vercel.app/api/answer', body,
                    {
                        headers: {
    ...
    const handleComment = async () => {
        if (comment !== "") {
            ...
            try {
                await axios.post(`https://stack-overflow-clone-backend.vercel.app/api/comment/${id}`, body,
                    {
                        headers: {
                            Authorization: window.localStorage.getItem("myToken"),
                            "Content-Type": "application/json"
    ...
    useEffect(() => {
        async function getQuestionData() {
            await axios.get(`https://stack-overflow-clone-backend.vercel.app/api/question/${id}`)
